...
export const SCREENS = [
  ...
  { id: 'surfaces', label: '面', note: 'クラスタ4。地の上に置く部品と、その場に留まる報告。' },
  { id: 'layout', label: 'レイアウト原始', note: 'クラスタ5。意味を持たない部品。12本すべてがここに並ぶ。' },
  ...
  { id: 'foundations', label: 'foundation の実験', note: '部品ではなく、トークンの値を実物で見比べる場。裁定の材料に使う。' },
] as const;
